...
class SignUpPageController extends GetxController {
  ...
  List<Widget> gerarTextFields() {
    return [
      ...
      MyTextFormField(controller: cnpj, hint: 'CNPJ',icon: const  Icon(Icons.business)),
      whoAreYouController.selectedUserType != 'Proprietário'?  Column(
        children: [
          const SizedBox(height: 8),
          MyTextFormField(controller: creci, hint: 'CRECI ex: CRECI-UF 00000',icon: const  Icon(Icons.business)),
          const SizedBox(height: 8),
        ],
      ) : const SizedBox(height: 8,),
